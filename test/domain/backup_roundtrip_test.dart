...
void main() {
  ...
  Profile buildProfile({String id = 'p1', String name = 'Alice Smith'}) =>
      Profile(
        id: id,
        name: name,
  ...
  test('encrypt → write → import roundtrip preserves profile data', () async {
    ...
    result.match((f) => fail('Import failed: ${f.message}'), (importResult) {
    ...
    getResult.match((f) => fail('getProfile failed: ${f.message}'), (imported) {
